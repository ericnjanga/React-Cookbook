...
import { Badge, Link as NavLink } from "@chakra-ui/react";
        ...
        <>
            ...
            <div className="row">
                ...
                <p>Coming back to the subscription logic issue described earlier, 
                    ...
                    <NavLink to="https://legacy.reactjs.org/docs/higher-order-components.html" isExternal>High Order Components (HOC) 
